...
namespace sdl
{
	ShaderProgram::ShaderProgram(char const* vertex_source, char const* fragment_source)
	...
	GLint ShaderProgram::get_attribute_handle(char const* attribute_name) const
	{
	...
	GLint ShaderProgram::get_uniform_handle(char const* uniform_name) const
	{
