...
namespace ql {
	...
	auto make_bow(reg& reg, id bow_id) -> id {
		make_item(reg, bow_id, 1.5_mass);

		make_breakable(reg, bow_id, {400_durability, 400_durability});
		...
		reg.assign<bow>(bow_id, &reg, bow_id);
