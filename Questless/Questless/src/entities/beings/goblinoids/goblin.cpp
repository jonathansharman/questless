...
namespace ql {
	...
	body goblin::make_body(ql::id<being> owner_id) {
		...
		public:
			goblin_torso(ql::id<being> owner_id) : torso
				...
				, make_uptr_vector<attachment>
					( umake<goblin_torso_attachment_head>(nullptr)
					, umake<goblin_torso_attachment_right_arm>(nullptr)
					, umake<goblin_torso_attachment_left_arm>(nullptr)
					, umake<goblin_torso_attachment_right_leg>(nullptr)
					, umake<goblin_torso_attachment_left_leg>(nullptr)
					)
				}
			{}
			view_space::polygon const& hitbox() const final {
		...
		auto root = umake<goblin_torso>(owner_id);
