...
namespace questless
{
	...
	Body Human::make_body()
	{
		...
		left_foot_modifiers.push_back(std::make_unique<Attributes::AgilityModifier>(15.0));
		...
		left_leg_modifiers.push_back(std::make_unique<Attributes::AgilityModifier>(35.0));
		...
		right_foot_modifiers.push_back(std::make_unique<Attributes::AgilityModifier>(15.0));
		...
		right_leg_modifiers.push_back(std::make_unique<Attributes::AgilityModifier>(35.0));
