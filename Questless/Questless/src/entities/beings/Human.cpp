...
namespace questless
{
	Human::Human(Game& game, const std::function<std::unique_ptr<Agent>(Being&)>& agent_factory, BeingId id)
		: CorporealBeing(game, agent_factory, id, make_body(), Attributes::of<Human>())
	{}
	...
	Body Human::make_body()
	{
		...
		auto left_foot = BodyPart::make<Foot>(*this, "Left foot", Modifier::make_vector(AgilityModifier::make(15.0)), foot_vitality, Protection::zero(), Resistance::zero(), Vulnerability::zero(), false, {ScreenRect{3, -11, 1, 1}, ScreenRect{1, -10, 2, 2}});
		auto left_leg = BodyPart::make<Leg>(*this, "Left leg", Modifier::make_vector(AgilityModifier::make(35.0)), leg_vitality, Protection::zero(), Resistance::zero(), Vulnerability::zero(), false, {ScreenRect{2, -2, 1, 1}, ScreenRect{1, -3, 2, 7}});
		left_leg->attach(move(left_foot));

		auto right_foot = BodyPart::make<Foot>(*this, "Right foot", Modifier::make_vector(AgilityModifier::make(15.0)), foot_vitality, Protection::zero(), Resistance::zero(), Vulnerability::zero(), false, {ScreenRect{-3, -11, 1, 1}, ScreenRect{-2, -10, 2, 2}});
		auto right_leg = BodyPart::make<Leg>(*this, "Right leg", Modifier::make_vector(AgilityModifier::make(35.0)), leg_vitality, Protection::zero(), Resistance::zero(), Vulnerability::zero(), false, {ScreenRect{-2, -2, 1, 1}, ScreenRect{-2, -3, 2, 7}});
