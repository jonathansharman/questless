...
namespace questless
{
	Human::Human(Game& game, const std::function<std::unique_ptr<Agent>(Being&)>& make_agent, BeingId id)
		: CorporealBeing{game, make_agent, id, make_body(), Attributes::of<Human>}
	{}
